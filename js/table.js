...
var myContainer = document.querySelector("#tablejs")
var mytable = '<table border="1"><thead>'+
"<tr><th>First Name</th>"+
"<th>Last Name</th>"+
"<th>Age</th>"+
"<th>Email</th></tr>"+
             "</thead>" ;// add the tag for table


for(var i = 0; i<users.length;i++){
    var email=users[i].email
mytable += "<tr><td>"+users[i].first_name+"</td>"+
...
myContainer.innerHTML = mytable + "</table>" // table end
