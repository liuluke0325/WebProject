...
var mycontainer=document.querySelector("#imgjs");

var myimg="<figure>";

for(var i = 0; i < images.length; i++){
myimg += "<img src="+images[i].url+" alt="+images[i].alt+"/><figcaption>"+images[i].caption+"</figcaption></br>";
}




mycontainer.innerHTML=myimg+"</figure>";
